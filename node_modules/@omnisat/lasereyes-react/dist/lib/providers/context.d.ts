...
export declare const LaserEyesStoreContext: import('react').Context<{
    ...
    methods: Pick<LaserEyesContextType, "switchNetwork" | "signPsbt" | "signMessage" | "requestAccounts" | "sendBTC" | "inscribe" | "getPublicKey" | "getNetwork" | "pushPsbt" | "getInscriptions" | "getBalance" | "disconnect" | "connect">;
}>;
